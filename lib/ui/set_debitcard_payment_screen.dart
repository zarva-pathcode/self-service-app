...
class SetDebitPaymentScreen extends StatefulWidget {
  const SetDebitPaymentScreen({super.key});

  @override
  State<SetDebitPaymentScreen> createState() => _SetDebitPaymentScreenState();
}

class _SetDebitPaymentScreenState extends State<SetDebitPaymentScreen> {
            ...
            child: FadeInRight(
              ...
              child: Text(
                ...
                textAlign: TextAlign.center,
                  ...
                  .swap(
                    builder: (_, __) => Text(
                      "Pemesanan Berhasil. Silahkan Melakukan Pembayaran Debit Dikasir...",
                      style: AppAssets().mediumTStyle.copyWith(
                            fontSize: size.width * .04,
                          ),
                      textAlign: TextAlign.center,
              ...
              child: isSuccess
                  ? SizedBox(
                      ...
                      child: LottieBuilder.asset(
                        AppAssets().cardPaymentAnimation,
                        fit: BoxFit.fitWidth,
                      ),
                    )
                  : SizedBox(
